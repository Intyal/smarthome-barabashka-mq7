...
//			Подготавливаем к работе дисплей:																			//	
			...
			_sendCommand(SSD1306_SET_MULTIPLEX_RATIO);	_sendCommand(0x1F);												//	Устанавливаем multiplex ratio (коэффициент мультиплексирования COM выводов) в значение 0x3F (по умолчанию).
			...
			_sendCommand(SSD1306_SET_COM_PINS);			_sendCommand(0x2);												//	Устанавливаем аппаратную конфигурация COM выводов в значение 0x12 (по умолчанию)
